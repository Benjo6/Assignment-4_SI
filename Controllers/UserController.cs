...
public class UserController : Controller
{
    ...
    public UserController(IUserRepository usrRepo, IActivityRepository actRepo, IReservationRepository resRepo,
...
// GET: api/user/5
    ...
    public IActionResult Put(long id, [FromBody] UserUpdateObject updateObj, bool fromMessage = false)
    {
        ...
        user.Roles = new HashSet<User.UserRole>() { Models.Entities.User.UserRole.Visitor };
